...
public class Main {
    ...
    public static void main(String[] args)
        ...
        Path fileName = Path.of("dblp.xml.100MB");
        ...
        sa.storeToFile();
			/*FileOutputStream file = new FileOutputStream("dblp100.dat");
			for (int i = 0; i < sa.lcp.length; i++) file.write(sa.lcp[i]);
			file.close();*/
    }
    ...
    public static class SuffixArray {
        ...
        public void storeToFile(){
            try {
                ...
                FileOutputStream file = new FileOutputStream("dblp100.dat");
                LittleEndianDataOutputStream dile = new LittleEndianDataOutputStream(file);
                for (int i = 0; i < N; i++){
                    dile.writeInt(lcp[i]);
                }
                dile.flush();
